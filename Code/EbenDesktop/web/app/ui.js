...
* ------v------*/
    ...
    addMachineHandlers() {
        document.getElementById("noVNC_shutdown_button")
            .addEventListener('click', UI.shutdownHost);
        document.getElementById("noVNC_reboot_button")
            .addEventListener('click', UI.rebootHost);
